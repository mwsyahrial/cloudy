						...
						<div class="form-group">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('nama_karyawan') ? 'is-invalid':'' ?>"
								 type="text" name="nama_karyawan" placeholder="Nama Karyawan"/>
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('tgl_terima') ? 'is-invalid':'' ?>"
								 type="date" name="tgl_terima" placeholder="Tanggal Terima"/>
								<div class="invalid-feedback">
