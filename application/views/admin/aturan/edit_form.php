                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
								...
								<input class="form-control <?php echo form_error('kode') ? 'is-invalid':'' ?>"
								 type="text" name="kode" min="0" placeholder="Kode" value="<?php echo $aturan->kode ?>" readonly/>
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('jabatan') ? 'is-invalid':'' ?>"
								 type="text" name="jabatan" placeholder="Jabatan" value="<?php echo $aturan->jabatan ?>"/>
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('masa_kerja') ? 'is-invalid':'' ?>"
								 type="number" name="masa_kerja" min="0" placeholder="Masa Kerja" value="<?php echo $aturan->masa_kerja ?>"/>
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('insentif') ? 'is-invalid':'' ?>"
								 type="number" name="insentif" min="0" placeholder="Insentif" value="<?php echo $aturan->insentif ?>" />
								<div class="invalid-feedback">
                            ...
                            <div class="form-group">
								...
								<input class="form-control <?php echo form_error('bonus') ? 'is-invalid':'' ?>"
								 type="number" name="bonus" min="0" placeholder="Bonus" value="<?php echo $aturan->bonus ?>"/>
								<div class="invalid-feedback">
									<?php echo form_error('insentif') ?>
								</div>
							</div>
